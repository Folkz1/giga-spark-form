  ...
  return (
    <div className="rounded-xl bg-slate-800/40 border border-slate-700/40 p-6 transition-all duration-200 hover:translate-y-[-2px] hover:border-slate-600 hover:shadow-lg hover:shadow-emerald-500/5">
      ...
      {data.offlineList.length > 0 && (
        <div className="border-t border-slate-700/40 pt-3 mt-3 space-y-1.5">
          <p className="text-[11px] text-slate-500 font-semibold uppercase tracking-wider mb-2">Instâncias offline</p>
